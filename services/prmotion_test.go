...
func TestPromotionCalculateDiscount(t *testing.T) {
	...
	cases := []testCase{
		{name: "appplied 100", purchaseMin: 100, discountPercent: 20, amount: 100, expected: 80},
		{name: "appplied 200", purchaseMin: 100, discountPercent: 20, amount: 200, expected: 160},
		{name: "appplied 300", purchaseMin: 100, discountPercent: 20, amount: 300, expected: 240},
		{name: "appplied 50", purchaseMin: 100, discountPercent: 20, amount: 50, expected: 50},
	}
	...
	t.Run("repository error", func(t *testing.T) {
		//Arrage
		promoRepo := repositories.NewPromotionRepositoryMock()
		promoRepo.On("GetPromotion").Return(repositories.Promotion{}, errors.New("err repository"))
		promoService := services.NewPromotionService(promoRepo)
